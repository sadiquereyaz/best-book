...
internal fun SearchScreen(
    ...
    ResultUiState: ResultUiState = ResultUiState.Loading,
    ...
    Column(modifier = modifier) {
        ...
        when (ResultUiState) {
            ...
            ResultUiState.LoadFailed,
            -> Unit

            ResultUiState.SearchNotReady -> SearchNotReadyBody()
            ResultUiState.EmptyQuery,
            -> {
            ...
            is ResultUiState.Success -> {
                if (ResultUiState.isEmpty()) {
                    ...
                    ResultBody(
                        searchQuery = searchQuery,
                        topics = ResultUiState.topics,
                        newsResources = ResultUiState.newsResources,
                        onSearchTriggered = onSearchTriggered,
                        onTopicClick = onTopicClick,
...
@Preview
@Composable
private fun EmptyResultColumnPreview() {
    NiaTheme {
        EmptyResultBody(
            onInterestsClick = {},
            searchQuery = "C++",
...
private fun SearchScreenPreview(
    ...
    NiaTheme {
        SearchScreen(ResultUiState = ResultUiState)
    }
}*/
